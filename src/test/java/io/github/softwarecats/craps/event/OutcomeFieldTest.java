...
public class OutcomeFieldTest {

    protected OutcomeField outcome = new OutcomeField(1);
    ...
    public void winAmountWithFraction() {
        Assert.assertEquals(
                ...
                outcome.winAmount(Fraction.getFraction(1, 2), throwWithSumTwo));
    ...
    public void WinAmountWithInt() {
        Assert.assertEquals(
                ...
                outcome.winAmount(1, throwWithSumTwo));
